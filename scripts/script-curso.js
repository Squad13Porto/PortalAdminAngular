...
document.getElementById('add-curso-novo').addEventListener('click', async function () {
    ...
    const nomeProfessor1 = document.querySelector('.nome-professor').value.trim();
    const titulacaoProfessor1 = document.querySelector('.titulacao-professor').value.trim();

    const nomeProfessor2 = document.querySelector('.nome-professor').value.trim();
    const titulacaoProfessor2 = document.querySelector('.titulacao-professor').value.trim();

    const nomeProfessor3 = document.querySelector('.nome-professor').value.trim();
    const titulacaoProfessor3 = document.querySelector('.titulacao-professor').value.trim();

    const nomeProfessor4 = document.querySelector('.nome-professor').value.trim();
    const titulacaoProfessor4 = document.querySelector('.titulacao-professor').value.trim();
    ...
    const imgBeneficioURL = await uploadImageAndGetURL(storageRef, '#img-beneficios', 'beneficios');
    ...
    const curso = {
        ...
        promessa, //string
        beneficios, //string
        imgBeneficio: imgBeneficioURL, //imagem no storage e armazenar download url no firestore
